...
all_events = ak.from_parquet("AllDatasets_WH_combined.parquet")
...
bin_settings = {
    ...
    "gen_ele_pt": (500, 0, 500),
    "gen_ele_eta": (100, 1, -1),
    "gen_ele_phi": (64, 1, -1),
    "matched_reco_ele_pt": (500, 0, 500),
    "matched_reco_ele_eta": (100, 1, -1),
    "matched_reco_ele_phi": (64, 1, -1),
    "gen_mu_pt": (500, 0, 500),
    "gen_mu_eta": (100, 1, -1),
    "gen_mu_phi": (64, 1, -1),
    "matched_reco_mu_pt": (500, 0, 500),
    "matched_reco_mu_eta": (100, 1, -1),
    "matched_reco_mu_phi": (64, 1, -1),
    "gen_ele_tauW_pt": (500, 0, 500),
    "gen_ele_tauW_eta": (100, 1, -1),
    "gen_ele_tauW_phi": (64, 1, -1),
    "matched_reco_ele_tau_pt": (500, 0, 500),
    "matched_reco_ele_tau_eta": (100, 1, -1),
    "matched_reco_ele_tau_phi": (64, 1, -1),
    "gen_mu_tauW_pt": (500, 0, 500),
    "gen_mu_tauW_eta": (100, 1, -1),
    "gen_mu_tauW_phi": (64, 1, -1),
    "matched_reco_mu_tau_pt": (500, 0, 500),
    "matched_reco_mu_tau_eta": (100, 1, -1),
    "matched_reco_mu_tau_phi": (64, 1, -1)
}
...
# Open ROOT file
root_filename = "hist_output_WH.root"
...
for dataset_name in unique_datasets:
    ...
    outdir = f"/eos/user/b/bbapi/www/WHToAA/{dataset_name}/"
