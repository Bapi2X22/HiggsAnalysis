...
def process_and_save(dataset_name, files):
    try:
        ...
        os.makedirs("parquet_files_ZH", exist_ok=True)
        out_file = os.path.join("parquet_files_ZH", f"{dataset_name}.parquet")
...
#             out_path = os.path.join("parquet_files_ZH", f"{ds}.parquet")
...
# Put all filesets into fallback order
...
if files:
    ...
    if labeled_arrays:
        ...
        table = ak.to_arrow_table(Events)
        pq.write_table(table, "AllDatasets_ZH.parquet", compression=None)
