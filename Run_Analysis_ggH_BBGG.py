...
fileset_local = {
    "M15_Run3Summer2022NanoAODv12": [
        "/eos/user/b/bbapi/MC_contacts/ggH_Run3_private_sample/CMSSW_13_0_13/src/HAHM_Nano_15_2022.root"
    ],
    "M20_Run3Summer2022NanoAODv12": [
        "/eos/user/b/bbapi/MC_contacts/ggH_Run3_private_sample/CMSSW_13_0_13/src/HAHM_Nano_20_2022.root"
    ],
    "M30_Run3Summer2022NanoAODv12": [
        "/eos/user/b/bbapi/MC_contacts/ggH_Run3_private_sample/CMSSW_13_0_13/src/HAHM_Nano_30_2022.root"
    ],
    "M45_Run3Summer2022NanoAODv12": [
        "/eos/user/b/bbapi/MC_contacts/ggH_Run3_private_sample/CMSSW_13_0_13/src/HAHM_Nano_45_2022.root"
    ],
    "M60_Run3Summer2022NanoAODv12": [
        "/eos/user/b/bbapi/MC_contacts/ggH_Run3_private_sample/CMSSW_13_0_13/src/HAHM_Nano_60_2022.root"
    ],
}
...
def process_and_save(dataset_name, files):
    try:
        ...
        os.makedirs("parquet_files_ggH_BBGG", exist_ok=True)
        out_file = os.path.join("parquet_files_ggH_BBGG", f"{dataset_name}.parquet")
...
def run_all_datasets(fileset_sources, max_workers=10, max_retries=3):
    ...
    for attempt in range(1, max_retries + 1):
        ...
        for ds in failed_datasets:
            out_path = os.path.join("parquet_files_ggH_BBGG", f"{ds}.parquet")
...
parquet_dir = "parquet_files_ggH_BBGG"
...
if files:
    ...
    if labeled_arrays:
        ...
        table = ak.to_arrow_table(Events)
        pq.write_table(table, "ggH_BBGG.parquet", compression=None)
