...
all_events = ak.from_parquet("AllDatasets_ggH.parquet")
...
mode = "selected"  # "create" to create new histograms, "update" to update existing ones, "selected" to process only selected branches

# If selected, specify# Selected branches
selected_branches = [("gen_photon_from_a_1_pt", "Genmatched_pho_1_pt"), ("gen_photon_from_a_2_pt", "Genmatched_pho_2_pt"), ("Gen_photon_pt_1", "Genmatched_pho_1_pt"), ("Gen_photon_pt_2", "Genmatched_pho_2_pt"), ("leading_A_pt", "subleading_A_pt"),
    ("lead_pt_pho_gen", "sublead_pt_pho_gen"),
    ("Reco_lead_pho_pt", "Reco_sublead_pho_pt"),
    ("A_pt_1", "A_pt_2")]  # example

# Open ROOT file
root_filename = "hist_output_ggH.root"
...
for dataset_name in unique_datasets:
    ...
    outdir = f"/eos/user/b/bbapi/www/ggHtoAA/{dataset_name}/"
